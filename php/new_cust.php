...
//----------------------------------------------------------------------------------------------------------------------------------
            ...
            if ($resultat == FALSE) { // S'il y a une erreur dans la requête sql
                ...
                $sql = "INSERT INTO customer (name_customer, fname_customer, num_customer, email_customer, status_customer, job_customer, last_company, password_customer) values ('" . $nom . "', '" . $prenom . "', '" . $tel . "', '" . $mail . "', '" . $statut . "', '" . $fonction . "', '" . $entreprise . "', '" . $pass_hash . "')";
                $resultat = mysqli_query($conn, $sql);
                if($resultat == FALSE){
                    $table = array(
                        'error'  => true,
